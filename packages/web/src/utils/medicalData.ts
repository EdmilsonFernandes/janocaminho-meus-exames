...
export const CATS: { key: string; cat: string; emoji: string; icon: SvgIconComponent; color: string; keys: string[] }[] = [
  ...
  { key: 'lipi', cat: 'Lipídios e Colesterol', emoji: '🧈', icon: GrainIcon, color: '#b45309', keys: ['colesterol', 'perfil lipidico', 'lipidico', 'lipidi', 'ldl', 'hdl', 'vldl', 'triglic', 'apolipo', 'castelli', 'nao-hdl', 'não-hdl'] },
  { key: 'hepa', cat: 'Função Hepática', emoji: '🫀', icon: HealingIcon, color: '#047857', keys: ['tgo', 'tgp', 'ast', 'alt', 'gama-gt', 'gama gt', 'ggt', 'gamagt', 'fosfatase alcalin', 'bilirrub', 'transamin', 'albumina'] },
  ...
  { key: 'infl', cat: 'Inflamação e Ferro', emoji: '🛡️', icon: ShieldIcon, color: '#c2410c', keys: ['pcr', 'vhs', 'proteina c reativa', 'proteína c reativa', 'ferritina', 'ferro', 'saturacao', 'saturação', 'transferr', 'tibc', 'uibc'] },
