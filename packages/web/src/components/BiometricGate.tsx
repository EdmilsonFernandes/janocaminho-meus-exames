      ...
      {locked && (
        <Box sx={{ position: 'fixed', inset: 0, zIndex: 9999, bgcolor: 'rgba(15,61,58,.98)', color: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 1.5, p: 3, textAlign: 'center' }}>
          ...
          {busy
            ...
            : <Button variant="contained" onClick={() => void prompt()} sx={{ borderRadius: '999px', px: 4, py: 1.1, textTransform: 'none', fontWeight: 800, fontSize: 15, bgcolor: '#20b2aa', '&:hover': { bgcolor: '#0f766e' } }}>Usar biometria</Button>}
