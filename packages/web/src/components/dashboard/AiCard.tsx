  ...
  <Card sx={{ mt: 2, position: 'relative', overflow: 'hidden', background: 'linear-gradient(135deg, rgba(32,178,170,.12), rgba(212,165,116,.08))', border: '1px solid', borderColor: 'rgba(32,178,170,.25)' }}>
    ...
    <CardContent sx={{ position: 'relative' }}>
      <Stack spacing={1.5}>
        {tip}
        <Box>
          <Button variant="contained" size="small" startIcon={<AutoAwesomeIcon />} onClick={onChat} sx={{ borderRadius: '999px', textTransform: 'none', fontWeight: 700, py: 1.1, background: 'linear-gradient(135deg,#20b2aa,#178f89)', boxShadow: '0 4px 12px rgba(32,178,170,.30)' }}>Conversar com a IA</Button>
        </Box>
      </Stack>
    </CardContent>
  </Card>
