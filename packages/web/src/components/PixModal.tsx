      ...
      <DialogContent sx={{ pb: 3 }}>
        ...
        {phase === 'waiting' && pix && (
          <Box>
            ...
            {pix.qrBase64 ? (
              <Box component="img" src={pix.qrBase64} alt="QR PIX" sx={{ width: 'min(220px, 64vw)', aspectRatio: '1 / 1', height: 'auto', borderRadius: '12px', border: '1px solid', borderColor: 'divider', display: 'block', mx: 'auto' }} />
